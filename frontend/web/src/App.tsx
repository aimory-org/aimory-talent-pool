...
function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 inset-x-0 h-0.5 bg-linear-to-r from-indigo-500 via-violet-500 to-purple-500 animate-gradient-x" />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="relative group">
          <div className="absolute -inset-0.5 bg-linear-to-r from-indigo-500 via-violet-500 to-purple-500 rounded-2xl opacity-20 blur group-hover:opacity-40 transition-opacity duration-500" />
