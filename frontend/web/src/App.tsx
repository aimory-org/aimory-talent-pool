        ...
        <div className="relative max-w-md w-full">
          ...
          <div className="relative bg-slate-800/80 backdrop-blur-xl rounded-2xl border border-red-500/20 p-8 shadow-2xl">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <p className="text-xs font-semibold text-red-400/70 uppercase tracking-wider">Access Restricted</p>
                <h3 className="text-lg font-semibold text-white">Company Account Required</h3>
              </div>
            </div>
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-6">
              ...
              <span className="text-white font-medium">
                {allowedEmailSuffixes.map((suffix: string) => suffix.replace(/^@?/, '@')).join(' or ')}
              </span>{' '}
    ...
    return (
      <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative bg-slate-800/60 backdrop-blur-xl rounded-2xl border border-white/10 p-10 text-center max-w-sm shadow-2xl">
          ...
          <p className="text-white/70 font-medium mb-1">Checking your session</p>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-purple-500/15 rounded-full blur-3xl animate-pulse-glow" style={{ animationDelay: '1s' }} />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-white mb-2 tracking-tight">Talent Pool</h1>
          ...
          <div className="relative bg-slate-800/80 backdrop-blur-xl rounded-2xl border border-white/10 p-8 shadow-2xl">
            <div className="text-center mb-8">
              ...
              <p className="text-white/50 text-sm leading-relaxed">
                Sign in to access the candidate resume database and manage your talent pipeline
              </p>
            </div>
            ...
            >
              <svg className="w-5 h-5 transition-transform group-hover/btn:scale-110" viewBox="0 0 21 21" fill="none">
